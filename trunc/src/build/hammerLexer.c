...
//   Comes from: 56:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' | '/' )+ | STRING )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start ID
 *
...
void mID(phammerLexer ctx)
{
    ...
    {
        //  hammer.g:56:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' | '/' )+ | STRING )
...
{
    {
        //  hammer.g:1:8: ( T__19 | T__20 | T__21 | T__22 | T__23 | ID | COMMENT | WS )
