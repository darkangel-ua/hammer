 ...
 *    1:1: Tokens : ( T__26 | T__27 | T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | SLASH | ID | COLON | COMMENT | WS );
 */
...
ANTLR3_CYCLIC_DFA cdfa6
    =	{
	    ...
	    (const pANTLR3_UCHAR)"1:1: Tokens : ( T__26 | T__27 | T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | SLASH | ID | COLON | COMMENT | WS );",	
...
//   Comes from: 70:4: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' | '*' )+ | STRING )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start ID
 *
...
void mID(phammerLexer ctx)
{
    ...
    {
        //  hammer.g:70:4: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' | '*' )+ | STRING )
...
void mSTRING(phammerLexer ctx)
{
    ...
    // hammer.g:74:8: ( '\"' STRING_ID '\"' )
    // hammer.g:74:10: '\"' STRING_ID '\"'
    {
        MATCHC('"'); 
        if  (HASEXCEPTION())
        {
...
{
    {
        //  hammer.g:1:8: ( T__26 | T__27 | T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | SLASH | ID | COLON | COMMENT | WS )
