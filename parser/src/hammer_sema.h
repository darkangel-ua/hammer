 ...
 *  - const hammer::ast::expression*      phammer_sema->path(phammer_sema)
 *  - void      phammer_sema->path_impl(phammer_sema)
 *  - pANTLR3_COMMON_TOKEN      phammer_sema->path_element(phammer_sema)
 *  - pANTLR3_COMMON_TOKEN      phammer_sema->wildcard(phammer_sema)
 *  - pANTLR3_COMMON_TOKEN      phammer_sema->wildcard_elem(phammer_sema)
 *  - void      phammer_sema->public_tag(phammer_sema)
 *  - const hammer::ast::expression*      phammer_sema->rule_invocation(phammer_sema)
 *  - const hammer::ast::expression*      phammer_sema->feature(phammer_sema)
...
struct hammer_sema_Ctx_struct
{
    ...
    pANTLR3_TREE_PARSER	    pTreeParser;
     ...
     const hammer::ast::expression* (*path)	(struct hammer_sema_Ctx_struct * ctx);
     void (*path_impl)	(struct hammer_sema_Ctx_struct * ctx, std::pair<pANTLR3_COMMON_TOKEN, pANTLR3_COMMON_TOKEN>* bounds);
     pANTLR3_COMMON_TOKEN (*path_element)	(struct hammer_sema_Ctx_struct * ctx);
     pANTLR3_COMMON_TOKEN (*wildcard)	(struct hammer_sema_Ctx_struct * ctx);
     pANTLR3_COMMON_TOKEN (*wildcard_elem)	(struct hammer_sema_Ctx_struct * ctx);
     ...
     const hammer::ast::expression* (*feature)	(struct hammer_sema_Ctx_struct * ctx);
