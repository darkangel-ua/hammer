 ...
 *  - hammerParser_source_public_tag_return      phammerParser->source_public_tag(phammerParser)
...
typedef struct hammerParser_source_public_tag_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammerParser_source_public_tag_return;
...
struct hammerParser_Ctx_struct
{
    ...
    pANTLR3_PARSER   pParser;
     ...
     hammerParser_source_public_tag_return (*source_public_tag)	(struct hammerParser_Ctx_struct * ctx);
