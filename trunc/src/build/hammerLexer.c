...
//   Comes from: 27:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' )+ | STRING )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start ID
 *
...
void mID(phammerLexer ctx)
{
    ...
    {
        //  hammer.g:27:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' )+ | STRING )
...

        {
            ...
            else 
            {
                ...
                EXCEPTION->message      = "27:1: ID : ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' )+ | STRING );";
    	        ...
    	        // hammer.g:27:9: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' )+
    	        {
    	        	...
    	        	switch (alt1) 
    	        	{
    	        	    case 1:
    	        	        // hammer.g:
    	        	        {
    	        	            if ( ((LA(1) >= '-') && (LA(1) <= '.')) || ((LA(1) >= '0') && (LA(1) <= '9')) || LA(1) == '=' || ((LA(1) >= 'A') && (LA(1) <= 'Z')) || LA(1) == '_' || ((LA(1) >= 'a') && (LA(1) <= 'z')) )
    	        	            {
    	        	                CONSUME();
...
{
    {
        //  hammer.g:1:8: ( T13 | T14 | T15 | T16 | ID | COMMENT | WS )
        ...
        default:
            CONSTRUCTEX();
            EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
            EXCEPTION->message      = "1:1: Tokens : ( T13 | T14 | T15 | T16 | ID | COMMENT | WS );";
