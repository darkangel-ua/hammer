...
//   Comes from: 25:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' )+ | STRING )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start ID
 *
...
void mID(phammerLexer ctx)
{
    ...
    {
        //  hammer.g:25:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' )+ | STRING )
...

        {
            ...
            else 
            {
                ...
                EXCEPTION->message      = "25:1: ID : ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' )+ | STRING );";
...
{
    {
        //  hammer.g:1:8: ( T12 | T13 | T14 | T15 | ID | COMMENT | WS )
        ...
        default:
            CONSTRUCTEX();
            EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
            EXCEPTION->message      = "1:1: Tokens : ( T12 | T13 | T14 | T15 | ID | COMMENT | WS );";
