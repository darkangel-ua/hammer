 ...
 *  - hammerParser_jam_rule_invoke_return      phammerParser->jam_rule_invoke(phammerParser)
 *  - hammerParser_jam_rule_invoke1_return      phammerParser->jam_rule_invoke1(phammerParser)
 *  - hammerParser_jam_rule_args_return      phammerParser->jam_rule_args(phammerParser)
...
typedef struct hammerParser_jam_rule_invoke_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammerParser_jam_rule_invoke_return;

typedef struct hammerParser_jam_rule_invoke1_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammerParser_jam_rule_invoke1_return;

typedef struct hammerParser_jam_rule_args_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammerParser_jam_rule_args_return;
...
typedef struct hammerParser_Ctx_struct
{
    ...
    hammerParser_jam_rule_invoke_return (*jam_rule_invoke)	(struct hammerParser_Ctx_struct * ctx);
    hammerParser_jam_rule_invoke1_return (*jam_rule_invoke1)	(struct hammerParser_Ctx_struct * ctx);
    hammerParser_jam_rule_args_return (*jam_rule_args)	(struct hammerParser_Ctx_struct * ctx);
    ...
    hammerParser_jam_block_return (*jam_block)	(struct hammerParser_Ctx_struct * ctx);    unsigned char * (*getGrammarFileName)();
