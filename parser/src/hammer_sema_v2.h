 ...
 *  - void      phammer_sema_v2->path_impl(phammer_sema_v2)
...
struct hammer_sema_v2_Ctx_struct
{
    ...
    pANTLR3_TREE_PARSER	    pTreeParser;
     ...
     void (*path_impl)	(struct hammer_sema_v2_Ctx_struct * ctx, hammer::parscore::source_location* root, hammer::ast::expressions_t* elements);
