 ...
 *  - const hammer::ast::statement*      phammer_sema->top_level_rule_invocation(phammer_sema)
 *  - void      phammer_sema->target_def_prefix(phammer_sema)
 *  - void      phammer_sema->arguments(phammer_sema)
 *  - const hammer::ast::expression*      phammer_sema->argument(phammer_sema)
 *  - const hammer::ast::expression*      phammer_sema->named_argument(phammer_sema)
 ...
 *  - const hammer::ast::path*      phammer_sema->target_ref_impl(phammer_sema)
 *  - void      phammer_sema->target_ref_spec(phammer_sema)
 *  - void      phammer_sema->target_ref_build_request(phammer_sema)
...
struct hammer_sema_Ctx_struct
{
    ...
    pANTLR3_TREE_PARSER	    pTreeParser;
     ...
     const hammer::ast::statement* (*top_level_rule_invocation)	(struct hammer_sema_Ctx_struct * ctx);
     void (*target_def_prefix)	(struct hammer_sema_Ctx_struct * ctx, hammer::parscore::source_location* explicit_tag, hammer::parscore::source_location* local_tag);
     ...
     const hammer::ast::expression* (*named_argument)	(struct hammer_sema_Ctx_struct * ctx);
     ...
     const hammer::ast::path* (*target_ref_impl)	(struct hammer_sema_Ctx_struct * ctx, hammer::parscore::identifier* target_name, hammer::ast::features_t* build_request);
     void (*target_ref_spec)	(struct hammer_sema_Ctx_struct * ctx, hammer::parscore::identifier* target_name, hammer::ast::features_t* build_request);
     void (*target_ref_build_request)	(struct hammer_sema_Ctx_struct * ctx, hammer::ast::features_t* build_request);
