 ...
 *  -  void      phammerLexer->T__48(phammerLexer)
 *  -  void      phammerLexer->T__49(phammerLexer)
 *  -  void      phammerLexer->T__50(phammerLexer)
...
struct hammerLexer_Ctx_struct
{
    ...
    pANTLR3_LEXER    pLexer;
     ...
     void (*mT__48)	(struct hammerLexer_Ctx_struct * ctx);
     void (*mT__49)	(struct hammerLexer_Ctx_struct * ctx);
     void (*mT__50)	(struct hammerLexer_Ctx_struct * ctx);
