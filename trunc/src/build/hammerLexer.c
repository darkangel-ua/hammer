...
static ANTLR3_INLINE void	mT__17    (phammerLexer ctx);
static ANTLR3_INLINE void	mT__18    (phammerLexer ctx);
...
(pANTLR3_INPUT_STREAM instream, pANTLR3_RECOGNIZER_SHARED_STATE state)
{
    ...
    lexCtx->mT__17	= mT__17;
    lexCtx->mT__18	= mT__18;
...
//   Comes from: 51:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' | '/' )+ | STRING )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start ID
 *
...
void mID(phammerLexer ctx)
{
    ...
    {
        //  hammer.g:51:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' | '/' )+ | STRING )
...
{
    {
        //  hammer.g:1:8: ( T__16 | T__17 | T__18 | T__19 | T__20 | ID | COMMENT | WS )
