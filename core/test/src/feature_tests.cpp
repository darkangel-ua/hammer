...
BOOST_AUTO_TEST_CASE(feature_compare_with_subfeatures)
{
   ...
   auto toolset_msvc = fr.create_feature("toolset", "msvc");

   auto toolset_msvc_11 = fr.create_feature("toolset", "msvc-11.0");
   BOOST_REQUIRE_EQUAL(toolset_msvc_11->subfeatures().size(), 1);
   BOOST_REQUIRE_EQUAL(toolset_msvc_11->subfeatures().front()->value(), "11.0");

   auto toolset_msvc_12 = fr.create_feature("toolset", "msvc-12.0");
...
BOOST_AUTO_TEST_CASE(feature_contains)
{
   ...
   auto gcc = fr.create_feature("toolset", "gcc");
   auto gcc_6 = fr.create_feature("toolset", "gcc-6");
   auto gcc_7 = fr.create_feature("toolset", "gcc-7");
