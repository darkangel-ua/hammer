 ...
 *  - hammer_v2Parser_target_ref_path_with_root_return      phammer_v2Parser->target_ref_path_with_root(phammer_v2Parser)
 *  - hammer_v2Parser_target_ref_path_without_root_return      phammer_v2Parser->target_ref_path_without_root(phammer_v2Parser)
 *  - hammer_v2Parser_target_ref_path_rest_return      phammer_v2Parser->target_ref_path_rest(phammer_v2Parser)
 ...
 *  - hammer_v2Parser_possible_spaces_return      phammer_v2Parser->possible_spaces(phammer_v2Parser)
 * 
 * 
 * 
 * 
...
typedef struct hammer_v2Parser_target_ref_path_with_root_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammer_v2Parser_target_ref_path_with_root_return;

typedef struct hammer_v2Parser_target_ref_path_without_root_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammer_v2Parser_target_ref_path_without_root_return;

typedef struct hammer_v2Parser_target_ref_path_rest_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammer_v2Parser_target_ref_path_rest_return;
...
typedef struct hammer_v2Parser_possible_spaces_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammer_v2Parser_possible_spaces_return;
...
struct hammer_v2Parser_Ctx_struct
{
    ...
    pANTLR3_PARSER   pParser;
     ...
     hammer_v2Parser_target_ref_path_with_root_return (*target_ref_path_with_root)	(struct hammer_v2Parser_Ctx_struct * ctx);
     hammer_v2Parser_target_ref_path_without_root_return (*target_ref_path_without_root)	(struct hammer_v2Parser_Ctx_struct * ctx);
     hammer_v2Parser_target_ref_path_rest_return (*target_ref_path_rest)	(struct hammer_v2Parser_Ctx_struct * ctx);
     ...
     hammer_v2Parser_possible_spaces_return (*possible_spaces)	(struct hammer_v2Parser_Ctx_struct * ctx);
