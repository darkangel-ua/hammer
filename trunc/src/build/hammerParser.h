 ...
 *  - hammerParser_source_decl_stub_return      phammerParser->source_decl_stub(phammerParser)
...
typedef struct hammerParser_source_decl_stub_return_struct
{
    /** Generic return elements for ANTLR3 rules that are not in tree parsers or returning trees
     */
    pANTLR3_COMMON_TOKEN    start;
    ...
    hammerParser_source_decl_stub_return;
...
struct hammerParser_Ctx_struct
{
    ...
    pANTLR3_PARSER   pParser;
     ...
     hammerParser_source_decl_stub_return (*source_decl_stub)	(struct hammerParser_Ctx_struct * ctx);
