 ...
 *    1:1: Tokens : ( T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | T__37 | SLASH | PUBLIC_TAG | ID | COLON | COMMENT | WS );
 */
...
static const ANTLR3_INT32 dfa6_accept[25] =
    {
	-1, -1, 2, 3, 4, 5, 6, 7, -1, 9, 10, 12, 13, 14, 15, 16, -1, 8, 11, -1, 
	-1, -1, -1, -1, 1
    };
...
static const ANTLR3_INT32 dfa6_T0[] =
	...
	-1, -1, -1, -1, 15, -1, 12, 14, -1, -1, -1, -1, 5, 6, 12, -1, 7, 12, 12, 
	8, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 13, 2, 3, 12, 4, -1, 11, 12, 
...
{
    dfa6_T3, dfa6_T8, dfa6_T_empty, dfa6_T_empty, dfa6_T_empty, dfa6_T_empty, 
    dfa6_T_empty, dfa6_T_empty, dfa6_T0, dfa6_T_empty, dfa6_T_empty, dfa6_T_empty, 
    dfa6_T_empty, dfa6_T_empty, dfa6_T_empty, dfa6_T_empty, dfa6_T6, dfa6_T_empty, 
    dfa6_T_empty, dfa6_T5, dfa6_T4, dfa6_T1, dfa6_T7, dfa6_T2, dfa6_T_empty	
};
...
ANTLR3_CYCLIC_DFA cdfa6
    =	{
	    ...
	    (const pANTLR3_UCHAR)"1:1: Tokens : ( T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | T__37 | SLASH | PUBLIC_TAG | ID | COLON | COMMENT | WS );",	
...
//   Comes from: 69:4: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' | '*' )+ | STRING )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start ID
 *
...
void mID(phammerLexer ctx)
{
    ...
    {
        //  hammer.g:69:4: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' | '_' | '=' | '*' )+ | STRING )
...
void mSTRING(phammerLexer ctx)
{
    ...
    // hammer.g:73:8: ( '\"' STRING_ID '\"' )
    // hammer.g:73:10: '\"' STRING_ID '\"'
    {
        MATCHC('"'); 
        if  (HASEXCEPTION())
        {
...
{
    {
        //  hammer.g:1:8: ( T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | T__37 | SLASH | PUBLIC_TAG | ID | COLON | COMMENT | WS )
