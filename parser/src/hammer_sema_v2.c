 ...
 *         error reporting.
 */
pANTLR3_UINT8   hammer_sema_v2TokenNames[47+4]
     = {
...
static void	path_impl    (phammer_sema_v2 ctx, hammer::parscore::source_location* root, hammer::ast::expressions_t* elements);
...
/** 
 * $ANTLR start path
 * hammer_sema_v2.gt:89:1: path returns [const hammer::ast::path* result] : ^( Path path_impl[&root, &elements] ) ;
 */
...
{   
    ...
    {
        // hammer_sema_v2.gt:92:2: ( ^( Path path_impl[&root, &elements] ) )
        // hammer_sema_v2.gt:92:4: ^( Path path_impl[&root, &elements] )
        {
 ...
 * hammer_sema_v2.gt:95:1: path_impl[hammer::parscore::source_location* root, hammer::ast::expressions_t* elements] : ( Slash ( path_element )+ | ( path_element )+ );
 */
static void
path_impl(phammer_sema_v2 ctx, hammer::parscore::source_location* root, hammer::ast::expressions_t* elements)
{   
    ...
    {
        {
            //  hammer_sema_v2.gt:96:2: ( Slash ( path_element )+ | ( path_element )+ )
            ...
            {
        	case 1:
        	    // hammer_sema_v2.gt:96:4: Slash ( path_element )+
        	    {
        	        ...
        	        // hammer_sema_v2.gt:96:48: ( path_element )+
        	        {
        	            int cnt11=0;
        	        	...
        	        	{
        	        	    case 1:
        	        	        // hammer_sema_v2.gt:96:49: path_element
        	        	        {
        	    ...
        	    break;
        	case 2:
        	    // hammer_sema_v2.gt:97:4: ( path_element )+
        	    {
        	        // hammer_sema_v2.gt:97:4: ( path_element )+
        	        {
        	            int cnt12=0;
        	        	...
        	        	{
        	        	    case 1:
        	        	        // hammer_sema_v2.gt:97:5: path_element
        	        	        {
