 ...
 *  - void      phammerLexer->T42(phammerLexer)
 *  - void      phammerLexer->T43(phammerLexer)
...
typedef struct hammerLexer_Ctx_struct
{
    ...
    void (*mT42)	(struct hammerLexer_Ctx_struct * ctx);
    void (*mT43)	(struct hammerLexer_Ctx_struct * ctx);
