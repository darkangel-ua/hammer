...
struct hammerParser_Ctx_struct
{
    ...
    pANTLR3_PARSER   pParser;
     ...
     ANTLR3_BOOLEAN (*synpred12_hammer)	(struct hammerParser_Ctx_struct * ctx);
     ANTLR3_BOOLEAN (*synpred13_hammer)	(struct hammerParser_Ctx_struct * ctx);
     ANTLR3_BOOLEAN (*synpred14_hammer)	(struct hammerParser_Ctx_struct * ctx);
    // Delegated rules
