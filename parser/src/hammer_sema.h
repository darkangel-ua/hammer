 ...
 *  - const hammer::ast::path_like_seq*      phammer_sema->path(phammer_sema)
 ...
 *  - const hammer::ast::path_like_seq*      phammer_sema->target_impl(phammer_sema)
...
struct hammer_sema_Ctx_struct
{
    ...
    pANTLR3_TREE_PARSER	    pTreeParser;
     ...
     const hammer::ast::path_like_seq* (*path)	(struct hammer_sema_Ctx_struct * ctx);
     ...
     const hammer::ast::path_like_seq* (*target_impl)	(struct hammer_sema_Ctx_struct * ctx, hammer::parscore::identifier* target_name, hammer::ast::features_t* build_request);
